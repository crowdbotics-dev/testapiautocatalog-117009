...
## Project Structure
    ...
    ├── testapiautocatalog_117009  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_117009`
...
2. Clone this repo and `cd testapiautocatalog_117009`
